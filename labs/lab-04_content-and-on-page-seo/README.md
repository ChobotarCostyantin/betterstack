...
```
1. Background and foreground colors do not have a sufficient contrast ratio - збільшити контрастність для вказаних UI елементів
2. Heading elements are not in a sequentially-descending order - треба поправити ієрархію залоголків
3. Browser errors were logged to the console - правильно обробляти помилки при перевірці на авторизованого користувача
```
