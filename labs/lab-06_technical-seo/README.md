...
1. Повільний TTFB (сервер/база/відсутність кешу).  
2. Неоптимізовані великі зображення (без WebP, srcset, lazy-load).  
3. Render-blocking JS/CSS (критичні ресурси блокують рендеринг).
